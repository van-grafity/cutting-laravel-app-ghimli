...
class SubconCuttingController extends Controller
{
    ...
    public function summary_report_group_cutting_order_record(Request $request)
    {
        ...
        $pdf = PDF::loadView('page.subcon.report', compact('group','date_start', 'date_end','cutting_summary','all_size_in_summary','general_total_pcs','general_total_dozen'))->setPaper('a4', 'landscape');
    ...
    public function print()
    {
        ...
        return view('page.subcon.print', compact('group'));
    }
