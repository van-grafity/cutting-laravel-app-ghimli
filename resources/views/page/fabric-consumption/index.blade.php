                ...
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="">
                                <select class="form-control" id="buyer" name="buyer" data-placeholder="Choose Buyer">
                                    <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="select2-navy">
                                <select class="form-control select2" id="gl_number" name="gl_number[]" multiple="multiple"  data-placeholder="Choose GL Number">
                                    @foreach ($gls as $gl)
...
<script type="text/javascript">
    ...
    let fabric_consumption_table = $('#fabric_consumption_table').DataTable({
        ...
        columns: [
            ...
            { data: 'planning_consumption', name: 'planning_consumption'},
            { data: 'actual_consumption', name: 'actual_consumption'},
            { data: 'balance', name: 'balance'},
            { data: 'completion', name: 'completion'},
            { data: 'replacement', name: 'replacement'},
        ],
        columnDefs: [
            { targets: [0,1,2,3,4,5,6,7], orderable: false, searchable: false },
        ],
        orderable: false,
        paging: false,
        responsive: true,
