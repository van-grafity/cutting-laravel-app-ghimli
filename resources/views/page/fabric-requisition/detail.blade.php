        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="remark">Remark <i>(Optional)</i></label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn_submit_modal').click(function() {
            ...
            $('#btn_submit_modal').html('<i class="fa fa-spinner fa-spin"></i> Loading...');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('fabric-issue.store') }}",
                        type: "POST",
                        data: $('#fabric_issue_form').serialize(),
                        success: function (data) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Success',
