                        ...
                        <tbody>
                            @foreach ($details as $detail)
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-primary btn-sm btn-detail-edit d-none" data-id="{{ $detail->id }}" data-url="{{ route('laying-planning.detail-edit', $detail->id) }}">Edit</a>
