                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($detail->fr_status == 'disabled')
                                            <a href="{{ route('fabric-requisition.show', $detail->fr_id) }}" class="btn btn-sm btn-outline-dark">Detail Fab</a>
                                        @else
                                            <a href="{{ route('fabric-requisition.createNota', $detail->id) }}" class="btn btn-sm btn-outline-dark">Create Fab</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
