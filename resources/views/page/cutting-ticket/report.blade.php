...
<body>
    <div>
        <table width="100%" style="margin-bottom: 0px !important; padding-bottom: 0px !important; font-weight: bold;">
            ...
            <tr>
                <td width="50%" style="font-size: 11px;">Style# :
                    {{ $data['cutting_order_record']->layingPlanningDetail->layingPlanning->style->style }}</td>
                ...
                <td width="50%" style="font-size: 11px;">Color :
                    {{ $data['cutting_order_record']->layingPlanningDetail->layingPlanning->color->color }}</td>
            </tr>
            <tr>
                <td width="50%" style="font-size: 11px;">Job/PO# :
                    {{ $data['cutting_order_record']->layingPlanningDetail->layingPlanning->gl->gl_number }}</td>
                <td width="50%" style="font-size: 11px;">Bundles :
                    {{ $data['cutting_order_record']->cuttingTicket->count() }}</td>
                <td width="50%" style="font-size: 11px;">Roll# :
                    {{ $data['cutting_order_record']->cuttingOrderRecordDetail->count() }}</td>
            </tr>
        </table>
