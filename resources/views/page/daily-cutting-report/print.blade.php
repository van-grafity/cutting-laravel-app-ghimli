        ...
        <div class="body-nota">
            <table class="table table-nota">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="1">{{ $data_daily['buyer'] }}</td>
                        <td colspan="1">{{ $data_daily['style'] }}</td>
                        <td colspan="1">{{ $data_daily['gl_number'] }}</td>
                        <td colspan="1">{{ $data_daily['color'] }}</td>
                        <td colspan="1">{{ $data_daily['mi_qty'] }}</td>
                        <td colspan="2">{{ $data_daily['previous_balance'] }}</td>
                        <td colspan="1">{{ $data_daily['total_qty_per_day'] }}</td>
                        <td colspan="1">{{ $data_daily['accumulation'] }}</td>
                        <td colspan="1">{{ $data_daily['completed'] }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>    
