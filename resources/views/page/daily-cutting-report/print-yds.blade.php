...
<head>
    ...
    <title>DAILY CUTTING OUTPUT REPORT (Yds ver.)</title>
            ...
            <table class="table table-nota">
                <thead class="">
                    <tr>
                        ...
                        <th rowspan="2">Previous Acumulation </br> (yds)</th>
                        <th rowspan="2">Acumulation </br> (yds)</th>
                    ...
                    @foreach ($data_per_buyer as $buyer)
                        @foreach($buyer->laying_plannings as $key_lp => $laying_planning)
                            <tr>
                                ...
                                <td>{{ $laying_planning->plan_yds }}</td>
                                <td>{{ $laying_planning->balance_to_cut }}</td>
                                @foreach($laying_planning->qty_per_groups as $group)
